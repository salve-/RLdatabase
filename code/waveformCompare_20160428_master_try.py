...
def filter_and_rotate(ac, rt, baz, rt_pcoda, ac_pcoda, cutoff, cutoff_pc,
    ...
    ac.filter('bandpass', freqmin=5, freqmax=16, corners=2, zerophase=True)
    rt.filter('bandpass', freqmin=5, freqmax=16, corners=2, zerophase=True)
...
if __name__ == '__main__':
    ...
    quakeml = '/import/two-data/salvermoser/waveformCompare/france_event_20160428.xml'

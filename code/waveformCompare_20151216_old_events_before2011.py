...
def remove_instr_resp(rt, ac, rt_pcoda, ac_pcoda, station, startev):
    ...
    """
    rt.detrend(type='demean')
    rt_pcoda.detrend(type='demean')
    if station == 'WET':
...
def plotWaveformComp(event, station, link, mode, filter_e, event_source):
    ...
    tag_name = os.path.join('OUTPU6', catalog + '_' + str(event.origins[0]['time'].date) +
    ...
    tag_name2 = os.path.join('OUTPU6/Phase_velocities', str(event)
    ...
    print 'Done.'
    plt.savefig(tag_name + '/' + tag_name[7:] + '_page_1.png')
    plt.close()
    ...
    plt.grid(True)
    print 'Done.'
    plt.savefig(tag_name + '/' + tag_name[7:] + '_page_2.png')
    plt.close()
    ...
    print 'Done.'
    plt.savefig(tag_name + '/' + tag_name[7:] + '_page_3.png')
    plt.close()
    ...
    plt.savefig(tag_name + '/' + tag_name[7:] + '_page_4.png')
    plt.close()
...
if __name__ == '__main__':
    ...
    if not os.path.exists('OUTPU6'):
        os.makedirs('OUTPU6')
    if not os.path.exists('OUTPU6/Phase_velocities'):
        os.makedirs('OUTPU6/Phase_velocities')

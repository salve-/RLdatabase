...
#    from IPython.core.debugger import Tracer; Tracer(colors="Linux")()
    dic = OrderedDict([
            ...
            ('peak_vertical_rotation rate', PRZ),
            ('peak_vertical_rotation rate_unit', 'nrad/s'),
...
if __name__ == '__main__':
    ...
    if not os.path.exists('database/static/OUTPUT'):
        os.makedirs('database/static/OUTPUT')
    if not os.path.exists('database/static/OUTPUT/Phase_velocities'):
        os.makedirs('database/static/OUTPUT/Phase_velocities')
